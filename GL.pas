...
var
   ...
   glAreTexturesResident: function(n: GLsizei; const textures: PGLuint;
   residences: PGLboolean): GLboolean; stdcall;
   ...
   glBitmap: procedure(Width, Height: GLsizei; xorig, yorig: GLfloat;
   xmove, ymove: GLfloat; const bitmap: PGLubyte); stdcall;
   ...
   glColorPointer: procedure(size: GLint; atype: GLenum; stride: GLsizei;
   ...
   internalFormat: GLenum; x, y: GLint; Width: GLsizei; border: GLint); stdcall;
   glCopyTexImage2D: procedure(target: GLenum; level: GLint;
   internalFormat: GLenum; x, y: GLint; Width, Height: GLsizei; border: GLint); stdcall;
   glCopyTexSubImage1D: procedure(target: GLenum; level, xoffset, x, y: GLint;
   Width: GLsizei); stdcall;
   glCopyTexSubImage2D: procedure(target: GLenum; level, xoffset, yoffset, x, y: GLint;
   ...
   glDrawElements: procedure(mode: GLenum; Count: GLsizei; atype: GLenum;
   const indices: Pointer); stdcall;
   glDrawPixels: procedure(Width, Height: GLsizei; format, atype: GLenum;
   ...
   pname: GLenum; params: Pointer); stdcall;
   ...
   glIndexPointer: procedure(atype: GLenum; stride: GLsizei;
   const pointer: Pointer); stdcall;
   ...
   glInterleavedArrays: procedure(format: GLenum; stride: GLsizei;
   const pointer: Pointer); stdcall;
   ...
   glMap1d: procedure(target: GLenum; u1, u2: GLdouble; stride, order: GLint;
   const points: PGLdouble); stdcall;
   glMap1f: procedure(target: GLenum; u1, u2: GLfloat; stride, order: GLint;
   const points: PGLfloat); stdcall;
   glMap2d: procedure(target: GLenum; u1, u2: GLdouble; ustride, uorder: GLint;
   v1, v2: GLdouble; vstride, vorder: GLint; const points: PGLdouble); stdcall;
   glMap2f: procedure(target: GLenum; u1, u2: GLfloat; ustride, uorder: GLint;
   v1, v2: GLfloat; vstride, vorder: GLint; const points: PGLfloat); stdcall;
   glMapGrid1d: procedure(un: GLint; u1, u2: GLdouble); stdcall;
   glMapGrid1f: procedure(un: GLint; u1, u2: GLfloat); stdcall;
   glMapGrid2d: procedure(un: GLint; u1, u2: GLdouble; vn: GLint;
   v1, v2: GLdouble); stdcall;
   glMapGrid2f: procedure(un: GLint; u1, u2: GLfloat; vn: GLint;
   v1, v2: GLfloat); stdcall;
   ...
   glNormalPointer: procedure(atype: GLenum; stride: GLsizei;
   const pointer: Pointer); stdcall;
   glOrtho: procedure(left, right, bottom, top, zNear, zFar: GLdouble); stdcall;
   glPassThrough: procedure(token: GLfloat); stdcall;
   glPixelMapfv: procedure(map: GLenum; mapsize: GLsizei;
   const values: PGLfloat); stdcall;
   glPixelMapuiv: procedure(map: GLenum; mapsize: GLsizei;
   const values: PGLuint); stdcall;
   glPixelMapusv: procedure(map: GLenum; mapsize: GLsizei;
   const values: PGLushort); stdcall;
   ...
   glPrioritizeTextures: procedure(n: GLsizei; const textures: PGLuint;
   ...
   glTexCoordPointer: procedure(size: GLint; atype: GLenum; stride: GLsizei;
   const pointer: Pointer); stdcall;
   ...
   glTexImage1D: procedure(target: GLenum; level, internalformat: GLint;
   Width: GLsizei; border: GLint; format, atype: GLenum; const pixels: Pointer); stdcall;
   ...
   glTexParameterfv: procedure(target: GLenum; pname: GLenum;
   const params: PGLfloat); stdcall;
   glTexParameteri: procedure(target: GLenum; pname: GLenum; param: GLint); stdcall;
   glTexParameteriv: procedure(target: GLenum; pname: GLenum;
   const params: PGLint); stdcall;
   glTexSubImage1D: procedure(target: GLenum; level, xoffset: GLint;
   Width: GLsizei; format, atype: GLenum; const pixels: Pointer); stdcall;
   glTexSubImage2D: procedure(target: GLenum; level, xoffset, yoffset: GLint;
   Width, Height: GLsizei; format, atype: GLenum; const pixels: Pointer); stdcall;
   ...
   glVertexPointer: procedure(size: GLint; atype: GLenum; stride: GLsizei;
   const pointer: Pointer); stdcall;
...
type
   ...
   PFNGLVERTEXPOINTEREXTPROC = procedure(size: GLint; atype: GLenum;
      stride, Count: GLsizei;
      const pointer: Pointer); stdcall;
   PFNGLNORMALPOINTEREXTPROC = procedure(atype: GLenum; stride, Count: GLsizei;
      const pointer: Pointer); stdcall;
   PFNGLCOLORPOINTEREXTPROC = procedure(size: GLint; atype: GLenum;
   ...
   // EXT_paletted_texture
   PFNGLCOLORTABLEEXTPROC = procedure(target, internalFormat: GLenum;
      Width: GLsizei; format, atype: GLenum;
      const Data: Pointer); stdcall;
   PFNGLCOLORSUBTABLEEXTPROC = procedure(target: GLenum; start, Count: GLsizei;
      format, atype: GLenum;
      const Data: Pointer); stdcall;
   PFNGLGETCOLORTABLEEXTPROC = procedure(target, format, atype: GLenum;
...
begin
   ...
   if hDLL = 0 then
      raise Exception.Create('Could not load OpenGL from ' + dll);
