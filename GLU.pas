...
var
   ...
   gluPickMatrix: procedure(x, y, Width, Height: GLdouble;
   viewport: TViewPortArray); stdcall;
   gluLookAt: procedure(eyex, eyey, eyez, centerx, centery, centerz,
   upx, upy, upz: GLdouble); stdcall;
   gluProject: function(objx, objy, objz: GLdouble;
   const modelMatrix, projMatrix: T16dArray; viewport: TViewPortArray;
   winx, winy, winz: PGLdouble): integer; stdcall;
   gluUnProject: function(winx, winy, winz: GLdouble;
   const modelMatrix, projMatrix: T16dArray; viewport: TViewPortArray;
   objx, objy, objz: PGLdouble): integer; stdcall;
   gluScaleImage: function(format: GLenum; widthin, heightin: GLint;
   typein: GLenum; const datain: Pointer; widthout, heightout: GLint;
   typeout: GLenum; dataout: Pointer): integer; stdcall;
   gluBuild1DMipmaps: function(target: GLenum; Components, Width: GLint;
   format, atype: GLenum; const Data: Pointer): integer; stdcall;
   gluBuild2DMipmaps: function(target: GLenum; Components, Width, Height: GLint;
   format, atype: GLenum; const Data: Pointer): integer; stdcall;
...
var
   ...
   gluQuadricTexture: procedure(quadObject: PGLUquadric;
   textureCoords: GLboolean); stdcall;
   gluQuadricOrientation:     procedure(quadObject: PGLUquadric;
   orientation: GLenum); stdcall;
   gluQuadricDrawStyle:  procedure(quadObject: PGLUquadric; drawStyle: GLenum); stdcall;
   gluCylinder: procedure(qobj: PGLUquadric; baseRadius, topRadius, Height: GLdouble;
   slices, stacks: GLint); stdcall;
   gluDisk: procedure(qobj: PGLUquadric; innerRadius, outerRadius: GLdouble;
   slices, loops: GLint); stdcall;
   gluPartialDisk: procedure(qobj: PGLUquadric; innerRadius, outerRadius: GLdouble;
   slices, loops: GLint; startAngle, sweepAngle: GLdouble); stdcall;
   gluSphere: procedure(qobj: PGLuquadric; radius: GLdouble;
   slices, stacks: GLint); stdcall;
   gluQuadricCallback: procedure(qobj: PGLUquadric; which: GLenum;
   fn: TCallBack); stdcall;
   ...
   gluTessVertex: procedure(tess: PGLUtesselator; coords: T3dArray;
   ...
   gluTessProperty: procedure(tess: PGLUtesselator; which: GLenum;
   Value: GLdouble); stdcall;
   ...
   gluGetTessProperty: procedure(tess: PGLUtesselator; which: GLenum;
   Value: PGLdouble); stdcall;
   ...
   gluPwlCurve: procedure(nobj: PGLUnurbs; Count: GLint; aarray: PGLfloat;
   stride: GLint; atype: GLenum); stdcall;
   gluNurbsCurve: procedure(nobj: PGLUnurbs; nknots: GLint; knot: PGLfloat;
   stride: GLint; ctlarray: PGLfloat; order: GLint; atype: GLenum); stdcall;
   gluNurbsSurface: procedure(nobj: PGLUnurbs; sknot_count: GLint;
   sknot: PGLfloat; tknot_count: GLint; tknot: PGLfloat; s_stride, t_stride: GLint;
   ctlarray: PGLfloat; sorder, torder: GLint; atype: GLenum); stdcall;
   gluLoadSamplingMatrices: procedure(nobj: PGLUnurbs;
   const modelMatrix, projMatrix: T16dArray; viewport: TViewPortArray); stdcall;
   gluNurbsProperty: procedure(nobj: PGLUnurbs; aproperty: GLenum;
   Value: GLfloat); stdcall;
   gluGetNurbsProperty: procedure(nobj: PGLUnurbs; aproperty: GLenum;
   Value: PGLfloat); stdcall;
...
type
   ...
   GLUtessCombineProc = procedure(p1: T3dArray; p2: T4pArray; p3: T4fArray;
      p4: PPointer); stdcall;
   ...
   GLUtessCombineDataProc = procedure(p1: T3dArray; p2: T4pArray;
      p3: T4fArray; p4: PPointer; p5: Pointer); stdcall;
...
begin
   ...
   if hDLL = 0 then
      raise Exception.Create('Could not load GLu from ' + dll);
